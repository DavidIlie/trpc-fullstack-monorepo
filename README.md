...
-  `prisma` package to give access to prisma to both the `server` directly and `trpc` (and can even be given direct access to the Next.js project to use in functions such as `getServerSideProps`)
